...
<body>
  <?php
    ...
    $emailSubject = "NEWSLETTER ADD: " . $emailAddress;
    $emailMessage = $emailAddress . " would like to receive info on any future changes to the menu, promotions, coupons, or updates.";
